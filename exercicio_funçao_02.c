/********************************************************************
 (comment in Portuguese)
   Faça um programa que recebe uma string de até 10
   caracteres do usuário. Dada esta, o programa deve
   conter uma função que divida esta string em outras
   duas strings a partir de sua metade. Lembre-se, neste
   caso é necessário passar para a função a string original
   e outros dois arrays de caracteres vazios.
*********************************************************************/
...
int main() {
    ...
    printf("%s %s %s", str, parte1, parte2);
